...
public class MyReplenishmentOrdersController extends AbstractSearchPageController
{
	...
	private static final Logger LOG = Logger.getLogger(MyReplenishmentOrdersController.class);
			...
			@RequestParam("productCode") final String productCode, final Model model)
	{
		...
		return B2bacceleratoraddonControllerConstants.Views.Pages.Checkout.ReadOnlyExpandedOrderForm;
	}
}
