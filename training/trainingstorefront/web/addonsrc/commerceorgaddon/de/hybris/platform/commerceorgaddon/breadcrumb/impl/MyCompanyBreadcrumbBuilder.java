...
public class MyCompanyBreadcrumbBuilder
{
	...
	public List<Breadcrumb> getBreadcrumbs(final String resourceKey) throws IllegalArgumentException
	{
		...
		{
			breadcrumbs.add(
					new Breadcrumb("#", getMessageSource().getMessage(resourceKey, null, getI18nService().getCurrentLocale()), null));
		}
	...
	public List<Breadcrumb> createManageUnitsDetailsBreadcrumbs(final String uid)
	{
		...
		breadcrumbs.add(
				new Breadcrumb(String.format("/my-company/organization-management/manage-units/details/?unit=%s", urlEncode(uid)),
	...
	public List<Breadcrumb> createManageCostCenterBreadCrumbs()
	{
		...
		breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-costcenters",
				messageSource.getMessage("text.company.manageCostCenters", null, i18nService.getCurrentLocale()), null));
		return breadcrumbs;
	}
	...
	public List<Breadcrumb> createManageUserDetailsBreadcrumb(final String uid)
	{
		...
		final CustomerData customer = this.getB2bUserFacade().getCustomerForUid(uid);
		final String userUrlValue = StringUtils.isNotBlank(customer.getCustomerId()) ? customer.getCustomerId() : uid;

		breadcrumbs.add(new Breadcrumb(
				String.format("/my-company/organization-management/manage-users/details?user=%s", urlEncode(userUrlValue)),
	...
	public List<Breadcrumb> createManageBudgetsBreadCrumbs()
	{
		...
		breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-budgets",
				messageSource.getMessage("text.company.manageBudgets", null, i18nService.getCurrentLocale()), null));
		return breadcrumbs;
	}
	...
	public List<Breadcrumb> createManagePermissionsBreadcrumb()
	{
		...
		breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-permissions",
				messageSource.getMessage("text.company.managePermissions", null, i18nService.getCurrentLocale()), null));
		return breadcrumbs;
	}
	...
	{
		final List<Breadcrumb> breadcrumbs = this.getBreadcrumbs(null);
		breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-usergroups",
				messageSource.getMessage("text.company.manageUsergroups.breadcrumb", null, i18nService.getCurrentLocale()), null));
		return breadcrumbs;
	}
	...
	public List<Breadcrumb> createManageUserGroupDetailsBreadCrumbs(final String uid)
	{
		...
		breadcrumbs.add(new Breadcrumb(
				String.format("/my-company/organization-management/manage-usergroups/details?usergroup=%s", urlEncode(uid)),
				messageSource.getMessage("text.company.manageUsergroups.details", new Object[]
	...
	public void addViewCostCenterBreadCrumbs(final List<Breadcrumb> breadcrumbs, final String costCenterCode)
	{
		breadcrumbs.add(new Breadcrumb(String.format(MANAGE_COSTCENTERS_VIEW_URL, urlEncode(costCenterCode)),
				messageSource.getMessage("text.company.costCenter.viewPage", new Object[]
	...
	{
		breadcrumbs.add(new Breadcrumb(
				String.format("/my-company/organization-management/manage-budgets/view/?budgetCode=%s", urlEncode(budgetCode)),
				messageSource.getMessage("text.company.budget.viewPage", new Object[]
	...
	public void addViewPermissionBreadCrumbs(final List<Breadcrumb> breadcrumbs, final String permissionCode)
	{
		breadcrumbs.add(new Breadcrumb(String.format(MANAGE_PERMISSIONS_VIEW_URL, urlEncode(permissionCode)),
				getMessageSource().getMessage("text.company.managePermissions.view.page", new Object[]
