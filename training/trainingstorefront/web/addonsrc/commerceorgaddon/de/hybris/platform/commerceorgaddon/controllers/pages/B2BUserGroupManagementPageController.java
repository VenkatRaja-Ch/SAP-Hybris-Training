...
public class B2BUserGroupManagementPageController extends MyCompanyPageController
{
	...
	@RequireHardLogIn
	public String disableUserGroup(@RequestParam("usergroup") final String usergroup) throws CMSItemNotFoundException
	{
	...
	@RequireHardLogIn
	public String removeUserGroup(@RequestParam("usergroup") final String usergroup, final RedirectAttributes redirectModel)
			throws CMSItemNotFoundException
	{
			...
			throws CMSItemNotFoundException
	{
		...
		// Handle paged search results
		final PageableData pageableData = createPageableData(page, getSearchPageSize(), sortCode, showMode);
		final SearchPageData<CustomerData> searchPageData = b2bUserGroupFacade.getPagedCustomersForUserGroup(pageableData, usergroup);
		populateModel(model, searchPageData, showMode);
