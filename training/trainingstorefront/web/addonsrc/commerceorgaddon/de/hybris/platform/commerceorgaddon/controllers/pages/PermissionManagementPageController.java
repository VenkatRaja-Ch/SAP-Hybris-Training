...
public class PermissionManagementPageController extends MyCompanyPageController
{
	...
	public String getSelectPermissionTypePage(final Model model) throws CMSItemNotFoundException
	{
		...
		if (ResponsiveUtils.isResponsive())
		{
			breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-permissions/add", getMessageSource()
					.getMessage("text.company.managePermissions.create.new.permission", null, getI18nService().getCurrentLocale()),
					null));
		}
		else
		{
	...
	public String getAddErrorPermissionPage(final Model model) throws CMSItemNotFoundException
	{
		...
		return ControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionAddErrorPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		breadcrumbs.add(new Breadcrumb(String.format("/my-company/organization-management/manage-permissions/%s/disable",
				urlEncode(permissionCode)), getMessageSource().getMessage("text.company.managePermissions.disable.breadcrumb",
				new Object[]
