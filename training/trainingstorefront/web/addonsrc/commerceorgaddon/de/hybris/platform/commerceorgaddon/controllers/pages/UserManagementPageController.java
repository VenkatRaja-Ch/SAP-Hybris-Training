...
public class UserManagementPageController extends MyCompanyPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		// Handle paged search results
		final PageableData pageableData = createPageableData(page, getSearchPageSize(), sortCode, showMode);
		final SearchPageData<CustomerData> searchPageData = b2bApproverFacade.getPagedApproversForCustomer(pageableData, customer.getUid());		//NOSONAR
		populateModel(model, searchPageData, showMode);
			...
			throws CMSItemNotFoundException
	{
		...
		// Handle paged search results
		final PageableData pageableData = createPageableData(page, getSearchPageSize(), sortCode, showMode);
		final SearchPageData<B2BPermissionData> searchPageData = b2bPermissionFacade.getPagedPermissionsForCustomer(pageableData, customer.getUid());	// NOSONAR
		populateModel(model, searchPageData, showMode);
			...
			throws CMSItemNotFoundException
	{
		...
		// Handle paged search results
		final PageableData pageableData = createPageableData(page, getSearchPageSize(), sortCode, showMode);
		final SearchPageData<B2BUserGroupData> searchPageData = b2bUserFacade.getPagedB2BUserGroupsForCustomer(pageableData, customer.getUid());	//NOSONAR
		populateModel(model, searchPageData, showMode);
