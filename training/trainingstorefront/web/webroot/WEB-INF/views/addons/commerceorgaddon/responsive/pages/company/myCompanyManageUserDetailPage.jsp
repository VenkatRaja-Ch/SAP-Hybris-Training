...
<c:choose>
    <c:when test="${not empty customerData.customerId}">
        <c:set var="userId" value="${customerData.customerId}"/>
    </c:when>
    <c:otherwise>
        <c:set var="userId" value="${customerData.uid}"/>
    </c:otherwise>
</c:choose>
...
<spring:url value="/my-company/organization-management/manage-users/edit" var="editUserUrl" htmlEscape="false">
    <spring:param name="user" value="${userId}" />
</spring:url>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="item-group">
                                    ...
                                    <span class="item-value">
                                        <c:if test="${not empty customerData.titleCode}"><spring:theme code="text.company.user.${customerData.titleCode}.name"/>&nbsp;</c:if>
