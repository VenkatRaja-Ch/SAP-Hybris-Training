...
<div class="account-section-content">
	<form:form action="${saveUrl}" id="editB2bBudgetform" data-date-format-for-date-picker="${dateFormatForDatePicker}" data-date-format-hint="${dateFormatHint}" modelAttribute="b2BBudgetForm"
				   method="POST">
		<div class="row">
