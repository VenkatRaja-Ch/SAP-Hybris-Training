...
<ul>
	<li><spring:theme code="checkout.multi.summary.orderPlacedBy"/>:&nbsp;<c:if test="${ not empty order.b2bCustomerData.titleCode }"><spring:theme code="text.company.user.${order.b2bCustomerData.titleCode}.name" text=""/>&nbsp;</c:if>${fn:escapeXml(order.b2bCustomerData.firstName)}&nbsp;${fn:escapeXml(order.b2bCustomerData.lastName)}</li>
