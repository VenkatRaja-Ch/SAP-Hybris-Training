...
<ul class="checkout-order-summary-list">
    <li class="checkout-order-summary-list-heading">
        ...
        <div class="address">
            <c:if test="${ not empty cartData.b2bCustomerData.titleCode }"><spring:theme code="text.company.user.${cartData.b2bCustomerData.titleCode}.name" text="N/A"/>&nbsp;</c:if>
            ${fn:escapeXml(cartData.b2bCustomerData.firstName)}&nbsp;${fn:escapeXml(cartData.b2bCustomerData.lastName)}
