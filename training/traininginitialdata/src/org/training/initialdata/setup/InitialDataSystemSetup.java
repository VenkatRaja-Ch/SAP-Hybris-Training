...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	private static final String MY_DELTAS = "myDeltas";
	...
	public List<SystemSetupParameter> getInitializationOptions()
	{
		...
		params.add(createBooleanSystemSetupParameter(MY_DELTAS, "Import Deltas",true));
	...
	{
		importImpexFile(context, MY_IMPEXES_PATH);
		importImpexFile(context, MY_ECENTA_NOTIFICATION_COMPONENT_IMPEX_PATH);
	}

	@SystemSetup(type = Type.PROJECT, process = Process.ALL)
	public void createProjectDataOnUpdate(final SystemSetupContext context)
	{
		if(getBooleanSystemSetupParameter(context, MY_DELTAS)){
			importImpexFile(context, MY_DELTAS_PATH);
		}
	}
